      ...
      {isExpanded && (
        <div className="px-4 pb-4 border-t border-gray-800">
          <textarea
            ...
            className="w-full mt-3 h-64 px-3 py-2 bg-gray-800 border border-gray-600 rounded-lg text-gray-300 text-sm font-mono resize-y focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent"
            placeholder="Section content..."
          />
          <p className="mt-2 text-xs text-gray-500">
            Use template variables like <code className="text-lime-400">${'${transcript}'}</code> to insert dynamic content.
          </p>
        </div>
      )}
    </div>
